...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="../output/sft_output/")
    ...
    file_handler = logging.FileHandler("../output/sft_output/sft.log")
    ...
    # ==================== 实验跟踪初始化 ====================
    swanlab.login(api_key="KENTN6iUnRmclaZZ7SG2Y")
    run = swanlab.init(
